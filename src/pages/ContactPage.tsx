      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden gradient-dark">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center animate-fade-in">
          <h1 className="luxury-heading mb-6 leading-none text-white font-normal text-6xl lg:text-7xl">
            Let&apos;s Create<br />
            <span className="text-orange-accent italic">Something Amazing</span>
          </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="animate-slide-up">
              ...
              <h2 className="luxury-heading text-5xl font-normal text-gray-900 mb-8 leading-tight">
                Start Your<br />
                <span className="text-blue-title italic">Creative Journey</span>
              </h2>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                    <svg className="w-6 h-6 text-blue-social" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-6">
                  <a
                    ...
                    className="w-12 h-12 bg-blue-social rounded-sm flex items-center justify-center text-white hover:scale-110 transition-transform duration-300"
                  >
                  ...
                  <a
                    ...
                    className={`w-12 h-12 bg-blue-social rounded-sm flex items-center justify-center text-white transition-transform duration-300 ${
                ...
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      ...
                      className="w-full bg-blue-social text-white py-4 px-6 rounded-sm font-semibold hover:bg-blue-social/90 transition-colors duration-300 focus:ring-2 focus:ring-blue-social focus:ring-offset-2"
                    >
